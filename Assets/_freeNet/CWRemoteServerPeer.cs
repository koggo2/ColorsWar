...
public class CRemoteServerPeer : IPeer
{
	...
	void IPeer.on_message(Const<byte[]> buffer)
	{
		...
		(this.freenet_eventmanager.Target as CWFreeNetEventManager).EnqueueNetworkMessage(msg);
	}

	void IPeer.on_removed()
	{
		(this.freenet_eventmanager.Target as CWFreeNetEventManager).EnqueueNetworkEvent(NETWORK_EVENT.disconnected);
	}
